...
function S23Card() {
  return (
    <Card className="bg-black bg-opacity-100 min-h-[500px] rounded-lg w-1/3 p-4 flex flex-col items-center justify-center transform transition-transform duration-500 hover:scale-105">
      ...
      <img src="/s23.webp" alt="Samsung s23 " className='h-[70%]' />
